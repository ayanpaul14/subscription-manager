...
//   FiLogOut, FiMenu, FiX
// } from "react-icons/fi";
// import { useAuth } from "../../context/AuthContext"; // 👈 two levels up
// import logo from "../../assets/logo.jpeg";

// function SidebarContent({ navItems, setSidebarOpen }) {
...
//       {/* Logout */}
//       <motion.button
//         onClick={() => { logout(); useNavigate()("/login"); }}
...
//             <FiX />
//           </button>
//           <SidebarContent navItems={navItems} setSidebarOpen={setSidebarOpen} />
//         </motion.aside>

//         {/* Desktop sidebar */}
//         <aside className="hidden lg:flex w-64 flex-shrink-0 flex-col py-6 px-4 min-h-screen relative z-10"
//                style={sidebarStyle}>
//           <SidebarContent navItems={navItems} setSidebarOpen={setSidebarOpen} />
//         </aside>
//       </>
    ...
    <div className="min-h-screen flex overflow-hidden bg-[#0f0a1e]">
      ...
      <>
        ...
        >
          ...
          <SidebarContent navItems={navItems} setSidebarOpen={setSidebarOpen} logout={logout} navigate={navigate} />
        </motion.aside>
